                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("View All",style: TextStyle(color: HexColor("FBA346"),fontSize: 18,fontWeight: FontWeight.w500))
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text("January Offer",style: TextStyle(fontSize: 28,fontWeight: FontWeight.w500)),
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 17,left: 16),
                        child: Text("January Offer",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500)),
                      ),
                    ],
                  ),
                  decoration: BoxDecoration(
